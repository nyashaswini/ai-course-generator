  ...
  return (
    <div className="shadow-sm rounded-md border cursor-pointer hover:border-primary">
      <Link href={"/course/" + course?.courseId}>
        {/* Static Image */}
        <Image
          src="/course card.jpg" // Static image path
          width={300}
          height={200}
      ...
      <div className="p-2">
        ...
        <div className="flex items-center justify-between">
          <h2 className="flex gap-2 items-center p-1 bg-purple-50 text-primary text-sm rounded-sm">
            <HiOutlineBookOpen /> {course?.courseOutput?.course?.noOfChapters} - Chapters
          </h2>
        ...
        {displayUser && (
          <div className="flex items-center gap-2 mt-2">
            {/* Static User Avatar */}
            <Image
              src="/course card.jpg" // Replace with a static avatar image path
              width={30}
              height={30}
